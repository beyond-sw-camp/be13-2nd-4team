...
public class ProjectController {
    ...
    @GetMapping("/{teamNo}")
    public ResponseEntity<List<ProjectResponseDto>> getProjectsByTeamNo(@PathVariable Long teamNo) {
        List<ProjectResponseDto> projects = projectService.getProjectsByTeamNo(teamNo);
